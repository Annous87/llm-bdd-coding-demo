...
- `BDD-Q1`: RESOLVED by Jira clarification comment (`1048174`): duplicate keeps same title and priority, starts active.
- `BDD-Q2`: RESOLVED by Jira clarification comment (`1048174`): duplicated item appears at the top.
- `BDD-Q3`: RESOLVED by Jira clarification comment (`1048174`): double click on the item triggers duplication.

## Human Classification Overrides
None found.

## Traceability
- Original Jira issue (`QE-36`):
  - User intent to duplicate a Todo.
- Jira acceptance criteria in issue description:
  - "The user can duplicate an existing Todo."
- Jira clarification comment (`1048174`):
